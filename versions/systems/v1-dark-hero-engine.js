...
export default class HeroEngine {
  ...
  constructor(player, opts = {}) {
    ...
    this.alwaysActive = opts.alwaysActive ?? true;
    ...
    if (typeof FormulaPack5 !== 'undefined') {
      this._actionInterval = FormulaPack5.getActionInterval(this.heroMgr.level || 1, player.speed || 3);
    } else {
      this._actionInterval = 800;
    }
