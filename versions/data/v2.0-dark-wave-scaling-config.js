...
export const WAVE_PHASES = [
  { until: 20,       spawnMult: 0.35, label: '초반 적응기' },
  { until: 120,      spawnMult: 0.40, label: '중반 정상전투' },
  { until: Infinity, spawnMult: 0.45, label: '후반 대혼전' },
];

// ── 아이템 드롭 (몹 한 마리당 고정) ──
export const DROP_CHANCE_PER_MOB = 0.18;   // 18% — 다양한 아이템 드롭 (시간대 무관)
