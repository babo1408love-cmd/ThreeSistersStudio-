...
const LEGACY_STAGES = [
  { id:1, name:'포자의 숲 입구', description:'평화롭던 숲에 포자의 기운이 퍼지기 시작했다',
    candy:{targetScore:800,moves:40,cols:6,rows:8,matchTarget:STAGE_DIFFICULTY.matchTarget(1),gemCount:STAGE_DIFFICULTY.gemCount(1)},     combat:{ waves:[
  ...
  { id:2, name:'감염된 동굴', description:'포자에 깊이 잠식된 어둠의 동굴',
    candy:{targetScore:1200,moves:35,cols:6,rows:8,matchTarget:STAGE_DIFFICULTY.matchTarget(2),gemCount:STAGE_DIFFICULTY.gemCount(2)},     combat:{ waves:[
  ...
  { id:3, name:'오염된 호수', description:'대마왕의 포자에 오염된 신비의 호수',
    candy:{targetScore:1500,moves:30,cols:6,rows:8,matchTarget:STAGE_DIFFICULTY.matchTarget(3),gemCount:STAGE_DIFFICULTY.gemCount(3)},     combat:{ waves:[
  ...
  { id:4, name:'버섯돌이 대마왕의 성', description:'모든 감염의 근원, 대마왕과의 최후의 결전',
    candy:{targetScore:2000,moves:30,cols:6,rows:8,matchTarget:STAGE_DIFFICULTY.matchTarget(4),gemCount:STAGE_DIFFICULTY.gemCount(4)},     combat:{ waves:[
