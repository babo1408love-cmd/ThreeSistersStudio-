...
const BABY_MIMIC_TYPES = [
  { name: '꼬마 미믹', color: '#FFD700', size: 0.8, hp: 3, speed: 1.5, gold: 5,  emoji: '🏆' },
  { name: '은빛 미믹', color: '#C0C0C0', size: 0.7, hp: 2, speed: 2.0, gold: 3,  emoji: '🥈' },
  { name: '루비 미믹', color: '#FF4444', size: 0.9, hp: 4, speed: 1.2, gold: 8,  emoji: '🔴' },
  { name: '에메랄드 미믹', color: '#44FF88', size: 0.75, hp: 3, speed: 1.8, gold: 6,  emoji: '💚' },
  { name: '다이아 미믹', color: '#88CCFF', size: 1.0, hp: 5, speed: 1.0, gold: 12, emoji: '💎' },
];

// ── 등급 시스템 (5단계) ──
const BELLY_RARITIES = [
  { name: 'Common',    label: '커먼',   color: '#aaaaaa', glow: 0,  weight: 40, goldMul: 1,   statMul: 1.0 },
  { name: 'Rare',      label: '레어',   color: '#3b82f6', glow: 5,  weight: 28, goldMul: 1.5, statMul: 1.2 },
  { name: 'Epic',      label: '에픽',   color: '#a855f7', glow: 10, weight: 18, goldMul: 2,   statMul: 1.5 },
  { name: 'Legendary', label: '레전드', color: '#f59e0b', glow: 16, weight: 10, goldMul: 3,   statMul: 2.0 },
  { name: 'Mythic',    label: '신화',   color: '#ef4444', glow: 22, weight: 4,  goldMul: 5,   statMul: 3.0 },
];
...
// ── 보상 아이템 타입 ──
const BELLY_REWARDS = [
  { type: 'gold',    emoji: '💰', baseValue: 8,   weight: 30 },
  { type: 'gold',    emoji: '💰', baseValue: 15,  weight: 15 },
  { type: 'gold',    emoji: '💎', baseValue: 30,  weight: 5 },
