...
export default class StageDirector {
  ...
  static prepare(stageLevel, options = {}) {
    ...
    const baseMobCount = 18 + Math.floor(stageNum * 3 / 2);  // ★ 6배 기본 몹 수
    const mobCountPerWave = Math.min(60, Math.round(baseMobCount * (MOB_COUNT_MULT[stageType] || 1)));
