...
export default class ShisenMatch {
  ...
  _render() {
    ...
    const tileSize = Math.min(40, Math.floor((window.innerWidth - 40) / cols));
    ...
    this.container.innerHTML = `
      <div class="shisen-scene" style="animation:fadeIn .3s ease-out;">
        ...
        <div class="scene-subtitle">같은 타일을 2번 꺾어 연결하세요!</div>
        <div class="info-bar">
      ...
      <style>
        ...
        .shisen-tile {
          ...
          font-size: ${Math.max(16, tileSize - 10)}px;
        ...
        .shisen-msg { font-size: 13px; color: #fbbf24; margin-top: 6px; min-height: 20px; }
      </style>
    `;
